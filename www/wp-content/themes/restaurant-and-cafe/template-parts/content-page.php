...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php echo ( !is_single() ) ? '<a href="' . esc_url( get_the_permalink() ) . '" class="post-thumbnail">' : '<div class="post-thumbnail">'; ?>
		<?php ( is_active_sidebar( 'right-sidebar' ) && ( $sidebar_layout == 'right-sidebar' ) ) ? the_post_thumbnail( 'restaurant-and-cafe-with-sidebar' ) : the_post_thumbnail( 'restaurant-and-cafe-without-sidebar' ) ; ?>
