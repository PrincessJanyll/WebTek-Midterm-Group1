...
function restaurant_and_cafe_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting(
        'restaurant_and_cafe_ed_banner_section',
        array(
            'default' => '',
...
function restaurant_and_cafe_customize_preview_js() {
	wp_enqueue_script( 'restaurant_and_cafe_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
